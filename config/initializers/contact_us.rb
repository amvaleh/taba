...
ContactUs.setup do |config|
  ...
  config.mailer_from = "Tahapouyeshinfo@gmail.com"

  # Configure the e-mail address which should receive the contact form email notifications.
  config.mailer_to = "info@tahapouyesh.com"
  ...
  # Configure the redirectU bgRL after a successful submission
  config.success_redirect = '/dashboard/contact_success'
